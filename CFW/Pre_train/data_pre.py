...
def get_data(data, export_test=True):
    ...
    # Divide the data in a ratio of 6:2:2
    # First division: 80% for training+validation set, 20% for testing set
    ...
    # Second partition: Divide 20% of the training+validation set into the validation set
    ...
    if export_test:
        ...
        test_data_df.to_csv('Test set file path', index=False)
